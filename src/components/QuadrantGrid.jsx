  ...
  return (
    <div className="w-full relative" style={{ aspectRatio: '1 / 1' }}>
      ...
      <div className="absolute -bottom-10 left-0 right-0 flex justify-between">
        <span className="text-[12px] text-white font-semibold whitespace-nowrap px-2.5 py-1 rounded-full" style={{ background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.4)' }}>← {board.xAxis.left}</span>
        <span className="text-[12px] text-white font-semibold whitespace-nowrap px-2.5 py-1 rounded-full" style={{ background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.4)' }}>{board.xAxis.right} →</span>
      </div>
      {/* Y axis */}
      <div className="absolute top-0 bottom-0 flex flex-col justify-between py-1 items-center" style={{ width: 32, left: -40 }}>
        <span
          ...
          style={{ background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.4)', transform: 'rotate(-90deg) translateX(50%)', transformOrigin: 'center', position: 'absolute', top: '25%' }}
        >
          ↑ {board.yAxis.top}
        </span>
        <span
          className="text-[12px] text-white font-semibold whitespace-nowrap px-2.5 py-1 rounded-full"
          style={{ background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.4)', transform: 'rotate(-90deg) translateX(-50%)', transformOrigin: 'center', position: 'absolute', top: '75%' }}
        >
          ↓ {board.yAxis.bottom}
        </span>
      </div>
